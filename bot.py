...
async def rent_terms(callback_query: types.CallbackQuery):
    await callback_query.message.answer(
        ...
        text="Арендодатель обязуется:"
             "\n1️⃣ Предоставить во временное владение и пользование Арендатору указанное транспортное средство."
             "\n2️⃣ При обнаружении недостатков предоставленного в прокат транспортного средства, полностью или частично препятствующих пользованию им, Арендодатель обязан незамедлительно устранить недостатки, либопроизвести замену данного имущества другим аналогичным имуществом, находящимся в исправном состоянии."
             "\n3️⃣ Если недостатки имущества явились следствием нарушения Арендатором правил эксплуатации и содержания имущества, Арендатор оплачивает Арендодателю стоимость ремонта и транспортировки имущества. При этом ремонт имущества Арендодатель вправе осуществить как своими силами, так и с помощью специализированных мастерских по ремонту либо иных организаций, оказывающих соответствующие услуги."
             "\n4️⃣ Осуществлять капитальный и текущий ремонт транспортного средства."
             "\nАрендодатель вправе:"
             "\n1️⃣ Осуществлять проверку порядка использования Арендатором арендуемого транспортного средства в соответствии с условиями настоящего договора."
             "\n2️⃣Арендатор обязуется:"
             "\nИспользовать транспортное средство в соответствии с его назначением Соблюдать надлежащий режим эксплуатации транспортного средства. Исключить доступ к арендуемому имуществу некомпетентных лиц. Содержать арендуемое имущество в полной исправности. Возместить Арендодателю стоимость ремонта и транспортировки имущества, если недостатки имущества явились следствием нарушения Арендатором правил эксплуатации и содержания имущества. При этом ремонт имущества Арендодатель вправе осуществить как своими силами, так и с помощью специализированных мастерских по ремонту либо иных организаций, оказывающих соответствующие услуги. Представить Арендодателю копию водительского удостоверения на свое имя на право управления транспортным средством категории "A". По истечении срока проката передать имущество Арендодателю в состоянии, в котором оно было получено, с учетом амортизации, по передаточному акту."
             "\nАрендатор не вправе:"
             "\n передавать в субаренду имущество, передавать свои права и обязанности по договору проката другому лицу, предоставлять имущество в безвозмездное пользование производить залог арендных прав и вносить их в качестве имущественного вклада в хозяйственные товарищества и общества или паевого взноса в производственные кооперативы."
             "\n Арендная плата:"
             "\n Величина арендной платы является фиксированной в течение всего срока действия настоящего договора и не подлежит изменению. В случае досрочного возврата имущества Арендатором, остаток арендной платы не возвращается (если этот пункт не согласован заранее)",
